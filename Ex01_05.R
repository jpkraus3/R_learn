...
# To load "datasets," the built-in R datasets package, either click on "datasets" in the package manager or type either of the following
?library
library(datasets)
?require
require(datasets)
...
# Or, in Rstudio, click on the dataset in "Workspace," which uses the "fix" function and makes it possible to edit the dataset in a new window
